import sys
from PyQt5.QtCore import Qt, QUrl, QTimer, QTime,QRect
...
class MainWindow(QWidget):
    ...
    def initUI(self):
        ...
        self.settings_pushbutton = QPushButton("Settings")
        self.settings_pushbutton.clicked.connect(self.openSettings)
        
        
        layout.addWidget(self.settings_pushbutton)
...
class SettingsDialog(QDialog):
    def __init__(self):
        ...
        snooze_rowLayout = QHBoxLayout()
        self.snooze_label = QLabel("Snooze minutes ")
        self.lineEdit = QLineEdit()
        self.lineEdit.setFixedWidth(50)
        self.lineEdit.setValidator(QIntValidator())
        snooze_rowLayout.addWidget(self.snooze_label)
        snooze_rowLayout.addWidget(self.lineEdit)
        
        
        self.layout.addLayout(snooze_rowLayout)
        ...
        hbox.addWidget(self.confirm_pushbutton)
